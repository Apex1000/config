...
def error_404(request,exception):
    message = {
        "errors":"Request API Endpoint not Found"
    }
    response = JsonResponse(data = {"errors":"Request API not Found","status":404})
...
def error_500(request,*args, **argv):
    ...
    response = JsonResponse(data = {"errors":"Request API not Found","status":500})
